...
const Header = () => {
  return (
    ...
    <div className="flex justify-around mx-10 relative z-50">
      <NavLink to="/login" className=" px-8 py-2 hover:border hover:transition duration-500 hover:scale-110  ">Login</NavLink>
      ...
      <NavLink to="/notes/8" className=" px-8 py-2 hover:border hover:transition duration-500 hover:scale-110">Notes(View)</NavLink>
